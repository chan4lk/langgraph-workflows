...
from swot_analyzer.nodes import strengths_node, weaknesses_node, opportunities_node, threats_node, output_node, summarize_analysis
...
graph_builder.add_edge( START , "strengths_node" )
